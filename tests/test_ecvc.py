...
class ECVCTestCase(unittest.TestCase):
    ...
    def test_predict(self) -> None:
        ...
        count_vector = vc.ECVC()
        count_vector.fit(x)
        count_vector.set_threshold([[0, 0, 3, 0], [0, 4]], [[4, 5, 5, 5, 5, 7, 8]])

        pred = count_vector.predict(x_test)
        self.assertListEqual(pred, [0, 1, 0])
